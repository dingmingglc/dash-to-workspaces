...
import { SETTINGS, tracker, USE_SAFE_DEFAULTS_CONFLICTING } from './extension.js'
...
export const Taskbar = class extends EventEmitter {
  constructor(panel) {
    ...
    let setAttributes = () => {
      ...
      // 修复：在 USE_SAFE_DEFAULTS_CONFLICTING 模式下，如果只有一个显示器，强制显示收藏图标
      ...
      this.showFavorites =
        ...
        (this.dtpPanel.isPrimary ||
          ...
          (USE_SAFE_DEFAULTS_CONFLICTING && isOnlyOneMonitor))
